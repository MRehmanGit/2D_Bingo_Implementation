...
class Bingo{
    ...
    ******************************************/
    void initObjBingo();
    void destroyObj();
    bool isPresent(int column, int value);
    bool duplicate(int row, int randomValue);
    bool same(int row, int column, int variable);
    bool reInitDuplicates(int row, int column, int variable);
    bool isEnd();
